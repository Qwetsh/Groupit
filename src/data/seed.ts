...
const enseignantsData: Omit<Enseignant, 'id' | 'createdAt' | 'updatedAt'>[] = [
  ...
  { nom: 'AUBERNIAS', prenom: 'Marie', matierePrincipale: 'Français', classesEnCharge: ['3A', '3D', '3E'], estProfPrincipal: true, classePP: '3A', tags: [], adresse: "3 RUE DU HAUT POIRIER", commune: "METZ 57000", geoStatus: 'pending' },
  ...
  { nom: 'CHARLES', prenom: 'Thomas', matierePrincipale: 'SVT', classesEnCharge: ['3A', '3B', '3C', '3D', '3E'], estProfPrincipal: true, classePP: '3A', tags: [], adresse: "3 AVENUE REPUBLIQUE", commune: "BRIEY 54150", geoStatus: 'pending' },
  ...
  { nom: 'GABRIEL', prenom: 'Christine', matierePrincipale: 'Mathématiques', classesEnCharge: ['3A', '3B'], estProfPrincipal: true, classePP: '3A', tags: [], adresse: "1 RUE RENE CASSIN", commune: "METZ 57050", geoStatus: 'pending' },
  ...
  { nom: 'GENTILLET', prenom: 'Julie', matierePrincipale: 'Allemand', classesEnCharge: ['3A', '3B', '3C', '3D', '3E'], estProfPrincipal: true, classePP: '3A', tags: [], adresse: "13 RUE DE LA CHENEAU", commune: "SCY-CHAZELLES 57160", geoStatus: 'pending' },
  ...
  { nom: 'JASKOWIAK', prenom: 'Hugo', matierePrincipale: 'EPS', classesEnCharge: ['3C', '3E'], estProfPrincipal: true, classePP: '3C', tags: [], adresse: "8 SQUARE MICHEL PRAILLON", commune: "METZ 57000", geoStatus: 'pending' },
  ...
  { nom: 'KRENC', prenom: 'Carine', matierePrincipale: 'Mathématiques', classesEnCharge: ['4D', '4E', '4F'], estProfPrincipal: true, classePP: '4D', tags: [], adresse: "1 IMPASSE DES PEUPLIERS", commune: "LORRY LES METZ 57050", geoStatus: 'pending' },
  ...
  { nom: 'MANSOURI M JAHED', prenom: 'Ahmed', matierePrincipale: 'Technologie', classesEnCharge: ['3A', '3B'], estProfPrincipal: true, classePP: '3A', tags: [], adresse: "27 RUE RABELAIS", commune: "METZ 57000", geoStatus: 'pending' },
  ...
  { nom: 'PIZZOL', prenom: 'Stéphanie', matierePrincipale: 'Mathématiques', classesEnCharge: ['3C', '3D', '3E'], estProfPrincipal: true, classePP: '3C', tags: [], adresse: "1 RUE DE LA COTE BIEUVE", commune: "ROZERIEULLES 57160", geoStatus: 'pending' },
  ...
  { nom: 'SCHURCH', prenom: 'Marion', matierePrincipale: 'EPS', classesEnCharge: ['3D'], estProfPrincipal: true, classePP: '3D', tags: [], adresse: "45 RUE DU NORD", commune: "LE BAN SAINT MARTIN 57050", geoStatus: 'pending' },
  ...
  { nom: 'THIRY', prenom: 'Amandine', matierePrincipale: 'Anglais', classesEnCharge: ['3D', '3E'], estProfPrincipal: true, classePP: '3D', tags: [], adresse: "1 RUE PIERRE CURIE", commune: "PAGNY SUR MOSELLE 54530", geoStatus: 'pending' },
