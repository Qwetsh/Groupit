      ...
      const scenarioData = {
        ...
        parametres: {
          ...
          custom: selectedType === 'custom' ? {
            ...
            adulteRole: 'Tuteur',
            sansAdultes: !useJurys,
            critereParity: 'normal' as const,
            critereEnseignantAEleve: 'off' as const,
            critereMemeClasse: 'off' as const,
            critereLV: 'off' as const,
            critereVolumeHoraire: false,
            useTimeSlots: false,
            demiJournees: [],
            heureDebutMatin: '08:00',
            heureDebutAprem: '13:30',
          } : undefined,
        },
      };
